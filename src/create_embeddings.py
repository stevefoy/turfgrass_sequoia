...
# Function to extract features using DINO V2
def extract_features_dino(dataloader, embeddings_folder):
...
def process_image_files(input_directory, base_image_name, crop_folder):
    ...
    # files_to_check = [base_image_name, ndvi_rgb_file, nir_file, ndvi_file, red_file]
...
if __name__ == "__main__":
    ...
    for folder in folders:
        ...
        features, paths = extract_features_dino(dataloader, embeddings_folder)
